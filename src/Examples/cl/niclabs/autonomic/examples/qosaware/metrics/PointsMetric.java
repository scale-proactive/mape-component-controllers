...
public class PointsMetric extends Metric<String> {
	...
	public String calculate() {
		...
		if ( !(w.isValid()) && !(w1.isValid() && w2.isValid()) ) {
			System.err.println("[WARNING. PointsMetrics] PointsMetric fail when trying to get cracker avgOut or solvers avgInc values");
		}
		...
		double n = 1000000.0;
		System.out.printf("[PointsMetric] %d\t%.3f\t%.3f\t%.3f", counter, w.getValue()/n, w1.getValue()/n, w2.getValue()/n );
