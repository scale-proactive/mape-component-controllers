...
public class HTTPImpl implements HTTPItf, BindingController {
	...
	public Wrapper<String> processHttpRequest(int val) {
		...
		if (SpringooCST.DEBUG) System.out.println("[HTTP] Making HTTP Request");
		...
		//make Jonas call
		Wrapper<String> response = jonas.processJonasCall(404);

		if (SpringooCST.DEBUG) System.out.println("[HTTP] HTTP Request finished");
	...
	public void setPoints(String points) {
		...
		System.out.println("[WARNING] HTTP set points \"" + points + "\" fails");
	}
	...
	public void bindFc(String name, Object itf) throws NoSuchInterfaceException {
		if (name.equals(SpringooCST.ITF_APACHE_SERVER_JONAS)) {
			...
			throw new NoSuchInterfaceException("itf not found on HTTP: " + name);
		}
	}
