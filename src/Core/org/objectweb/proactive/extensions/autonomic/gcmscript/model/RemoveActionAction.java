...
public class RemoveActionAction extends AbstractGCMProcedure {

	@Override
	public Object apply(List<Object> args, Context ctx) throws ScriptExecutionError {
		ActionNode node = (ActionNode) args.get(0);
	...
	public String getName() {
		return "remove-jaction";
	}

	@Override
	public Signature getSignature() {
		return new Signature(VoidType.VOID_TYPE, model.getNodeKind("jaction"));
	}
